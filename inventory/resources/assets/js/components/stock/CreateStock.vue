              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text" class="form-control" placeholder="Costo de compra"
                        v-model="stock.buying_price" @input="calculateSellingPrice" />
                    </div>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text" class="form-control" placeholder="Porcentaje de utilidad"
                             v-model="profitPercentage" @input="calculateSellingPrice" />
                    </div>
                  </div>
                </div>
                  ...
                  <div class="input-group">
                    ...
                    <div class="form-line">
                      <input type="text" class="form-control" placeholder="Precio de venta"
                        v-model="stock.selling_price" readonly />
                    </div>
                  </div>
                </div>
...
export default {
  ...
  methods: {
    calculateSellingPrice() {
      const cost = parseFloat(this.stock.buying_price);
      const percentage = parseFloat(this.profitPercentage);

      if (!isNaN(cost) && !isNaN(percentage)) {
        const profit = cost * (percentage / 100);
        this.stock.selling_price = (cost + profit).toFixed(2);
      } else {
        this.stock.selling_price = 0;
      }
    },
    findProduct() {
